...
@section('content')
                ...
                <div class="col-lg-12 col-sm-12" style="width: 100%;">
                    <div class="card hovercard">
                        <div class="card-background">
                            <img class="card-bkimg img-responsive" alt="cover" src="{{URL ($users->cover)}}">
                        </div>
    ...
    margin-top: -210px;">
            ...
            @endif
            <form action="{{Auth::id()}}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group profile-imge-edit">
                                    ...
                                    <input type="file" id="img" name="img" value="{{ asset($users->img )}}">
                                ...
                                <div class="form-group profile-imge-edit">
                                    ...
                                    <input type="file" id="cover" name="cover" value="{{ $users->cover }}">
